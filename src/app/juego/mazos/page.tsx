      ...
      <div className="flex justify-start w-full shrink-0 mb-6">
        {decks.length < 8 && (
          <Link 
            ...
            className="flex rounded-lg bg-gray-700 font-sans font-bold w-60 h-14 items-center justify-center text-white hover:bg-gray-600 gap-3 shadow-md transition-colors group"
          >  
