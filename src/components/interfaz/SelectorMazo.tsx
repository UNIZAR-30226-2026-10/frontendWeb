...
const SelectorMazo: React.FC<SelectorMazoProps> = ({ mazoSeleccionado, onMazoSeleccionado }) => {
  const [isOpen, setIsOpen] = useState(false);
  const menuRef = useRef<HTMLDivElement>(null);
  const mazos = ["Mazo de Fuego", "Mazo de Agua", "Mazo de Tierra", "Mazo de Aire"];
  ...
  return (
    <div className="relative w-full" ref={menuRef}>
      ...
      >
        <span className="text-white font-bold">{mazoSeleccionado}</span>
        <span 
