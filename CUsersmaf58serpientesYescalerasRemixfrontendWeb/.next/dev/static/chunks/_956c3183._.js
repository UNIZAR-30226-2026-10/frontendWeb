...
"[project]/src/services/cuentas.service.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function UserProvider({ children }) {
    _s();
    const [userEmail, setUserEmailState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const [isCargando, setIsCargando] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "UserProvider.useEffect": ()=>{
            const intentarAutoLogin = {
                "UserProvider.useEffect.intentarAutoLogin": async ()=>{
                    try {
                        const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$cuentas$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CuentaService"].cookieLogin();
            ...
            }["UserProvider.useEffect.intentarAutoLogin"];
            intentarAutoLogin();
        }
    }["UserProvider.useEffect"], []);
    const setUser = (email, newUsername)=>{
    ...
    const logout = async ()=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$cuentas$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CuentaService"].logout();
        } catch (error) {
...
_s(UserProvider, "79vaPtUTySfNlPx2Jf2DjHmtR9c=");
_c = UserProvider;
function useUser() {
    _s1();
...
//# sourceMappingURL=_956c3183._.js.map